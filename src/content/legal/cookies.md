...
Cookies are small text files that are stored on your device (computer, tablet, or mobile) when you visit a website. They are widely used to make websites work more efficiently, provide a better user experience, and supply information to the owners of the site.
...
3.  **Third-Party Cookies (Advertising & Analytics):** We use **Google AdSense** to serve advertisements when you visit our website. Google may use cookies to serve ads based on your prior visits to this or other websites. These cookies allow Google and its partners to serve ads to you based on your visit to our site and/or other sites on the Internet.
...
For more information on how we handle your data, please visit our **Privacy Policy**.