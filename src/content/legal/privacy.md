...
We only collect personal information that you provide to us voluntarily. This may include:

* **Communication Data:** If you contact us directly via email or a contact form, we may receive additional information about you such as your name, email address, and the contents of the message you send us.
* **Log Files:** Like most websites, we follow a standard procedure of using log files. These files log visitors when they visit websites. The information collected includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, and referring/exit pages. These are not linked to any information that is personally identifiable.
* **Analytics:** We use anonymous analytical data to understand how our users interact with the prompt library to improve the overall engineering experience.

---

## 4. User Rights (GDPR & CCPA Compliance)

We want to make sure you are fully aware of all of your data protection rights. Depending on your location, you are entitled to the following:
...
If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us at: **[Your Contact Email]**.